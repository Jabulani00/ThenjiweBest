...
export class AnalyticsPage implements OnInit {
  ...
  generateUpdateFrequencyChart() {
    combineLatest([
      ...
      this.firestore.collection('storeroom').valueChanges(),
    ])
      .pipe(
            ...
            datasets: [
              {
                ...
                backgroundColor: [
                  ...
                  'rgba(153, 102, 255, 0.5)',
                  'rgba(255, 159, 64, 0.5)',
                ], // Provide different background colors for each slice
                borderColor: [
                  'rgba(255, 99, 132, 1)',
                  'rgba(54, 162, 235, 1)',
                  'rgba(255, 206, 86, 1)',
                  ...
                  'rgba(153, 102, 255, 1)',
                  'rgba(255, 159, 64, 1)',
                ], // Provide corresponding border colors
                borderWidth: 1,
              },
            ],
          },
          options: {
            // No specific options required for pie chart
          },
        });
      });
  }
